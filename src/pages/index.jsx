  ...
  return (
    ...
    <header>
      ...
      <nav>
        ...
        <div className="Bars">
          <img src="../../assets/barras2.png"></img>
        </div>
      </nav>
    </header></div>
    ...
    <main>
      <div className="Infos">
        ...
        <a href="#AboutMe"><button>Sobre Mim <img src="../../assets/seta.gif"></img></button></a>
      </div>
      <div className="ImageContent">
        <img src="../../assets/codigo.jpeg"></img>
      </div>
    </main>
    <div id="AboutMe">
      ...
      <div id="Description">
        ...
        <div className="Experience">
          ...
          <img src="../../assets/projetos.png"></img>
        </div>
        <div className="Closure">
          <img src="../../assets/tecnologia.png"></img>
      ...
      <div className="SelectionTechnology">
        <div className="Selection">
          ...
          <div className="FirstSelection">
            ...
            <img src="../../assets/logohtml.png"></img></li>
            ...
            <img src="../../assets/logocss.png"></img></li>
            ...
            <img src="../../assets/logojs.png"></img></li>
            ...
            <img src="../../assets/logonode.png"></img></li></ul>
          </div>
          ...
          <img src="../../assets/logoreact.png"></img></li>
          ...
          <img src="../../assets/logopython.png"></img></li>
          ...
          <img src="../../assets/logojava.png"></img></li>
          ...
          <img src="../../assets/logophp.png"></img></li></ul>
          </div>
        </div>
        <div className="SelectedTechnology">
        <img src="../../assets/logohtml.png" className="ImageSelected"></img><hr/>
            ...
            <div className="card">
              <div className="image-content">
                ...
                <div className="card-image">
                  <img src="../../assets/projeto1.png" className="card-img"></img>
                </div>
              </div>
              <div className="card-content">
                ...
                <div className="buttons-card"><Button title="Acessar"></Button><a href="https://github.com/vhgimenez" target="_blank"><Button title="GitHub"></Button></a></div>
              </div>
            </div>
            <div className="card">
              <div className="image-content">
                <span className="overlay"></span>
                <div className="card-image">
                  <img src="../../assets/construcao.png" className="card-img"></img>
                </div>
              </div>
              <div className="card-content">
    ...
    <footer>
      <div className="Up">
        <a href="#"><img src="../../assets/setacima.gif"></img></a>
      </div>
      <div className="AdditionalData">
        ...
        <div className="Email">
        <img src="../../assets/logoemail.png"></img><p>impressaogimenez@gmail.com</p>
        </div></div>
        <div className="UpMobile">
        <a href="#"><img src="../../assets/setacima2.gif"></img></a>
        </div>
      </div>
      <div className="Networks">
        <a href="https://www.linkedin.com/in/victor-gimenez-5b486a240/" target="_blank"><img src="../../assets/logolinkedin.png"></img></a>
        <a href="https://github.com/vhgimenez" target="_blank"><img src="../../assets/logogithub.png"></img></a>
        <a href="https://wa.me/message/ADVPLDIFI2AUB1" target="_blank"><img src="../../assets/wpplogo.png"></img></a>
        <a href="https://instagram.com/vh_gimenez?igshid=MjEwN2IyYWYwYw==" target="_blank"><img src="../../assets/logoinstagram.png"></img></a>
      </div>
